...
Adicionalment es va simular el potencial de cada una de les tres distribucions considerades mitjançant l'algoritme de Jacobi ---els codis són als \cref{lst:condensador,lst:fils,lst:lliure}---.
...
\begin{figure}[htb]
  ...
  \input{./informe-1/figs/condensador.tex}
...
\begin{figure}[htb]
  \centering \small \sffamily
	\input{informe-1/figs/lliure.tex}
