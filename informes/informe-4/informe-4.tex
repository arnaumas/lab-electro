...
\begin{table}[htb]
  ...
  \label{tab:acoblament 4}
	\begin{tabular}{lS[table-parse-only]S[table-parse-only]S[table-parse-only]S[table-parse-only]S[table-parse-only]}
		\toprule
		& \multicolumn{5}{c}{$N_2$} \\ \cmidrule{2-6}
